...
The guide below is from a sample application to demonstrate XYO Core Kotlin integration.
</div>
...
<a href="https://github.com/XYOracleNetwork/sdk-core-kotlin/blob/master/sample/SampleApplication/app/src/main/java/com/example/sampleapplication/MainActivity.kt" 
...
<a href="https://github.com/XYOracleNetwork/sdk-core-kotlin" 
    rel="noopener noreferrer"
    target="_blank"
    >
      For the complete XYO Core Kotlin SDK on GitHub refer to this link
  <i class="p-2 fas fa-external-link-alt"></i>
</a>
...
<h1 align="left">
  <img alt="app with gps and origin hash" src="/docs/assets/initial_layout_gif.gif" width="280px" height="600px">
</h1>
...
<h1 align="left">
  <img alt="app with gps and origin hash" src="/docs/assets/create_origin_android.gif" width="280px" height="600px">
</h1>
