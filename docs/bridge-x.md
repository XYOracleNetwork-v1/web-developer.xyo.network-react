...
<div class="alert alert-info text-center" role="alert">
  ...
  <a href="https://bridgex.xyo.network/" rel="noopener noreferrer"><i class="fab fa-apple fa-2x p-3"></i></a>
  <a href="https://bridgex.xyo.network/" rel="noopener noreferrer"><i class="fab fa-linux fa-3x p-3"></i></a>
  <a href="https://s3.amazonaws.com/xyo-bridge-images/xyo-bridge-latest.img.tar.gz" rel="noopener noreferrer"><i class="fab fa-windows fa-3x p-3"></i></a>
</div>
